      ...
      appBar: QuietRoomAppBar(
        trailing: CircleAvatar(
          ...
          child: Text(
              ...
              style: GoogleFonts.notoSerif(color: Colors.white, fontWeight: FontWeight.w700)
          ),
        ),
      ),
      body: StreamBuilder<List<JournalEntry>>(
          stream: _service.getUserEntries(uid),
                ...
                children: [
                          ...
                          children: List.generate(
                            7,
                              ...
                              child: Container(
                                ...
                                height: 36,
                                decoration: BoxDecoration(
                                  color: i < streak.clamp(0, 7) ? AppTheme.primary : AppTheme.secondary.withValues(alpha: 0.3),
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting && recentEntries.isEmpty)
                    ...
                    ...recentEntries.map((e) {
                      ...
                      return _RecentEntryCard(entry: e, moodEmoji: moodData['emoji']!);
                    }),
